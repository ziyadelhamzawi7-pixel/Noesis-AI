...
class Settings(BaseSettings):
    ...
    drive_sync_max_downloads_per_minute: int = int(os.getenv("DRIVE_SYNC_MAX_DOWNLOADS", "30"))
    drive_sync_max_processing_per_minute: int = int(os.getenv("DRIVE_SYNC_MAX_PROCESSING", "20"))
    embedding_max_concurrent: int = int(os.getenv("EMBEDDING_MAX_CONCURRENT", "50"))

    # OpenAI API Tier 3 Rate Limits
    openai_tier: int = int(os.getenv("OPENAI_TIER", "3"))
    embedding_rpm_limit: int = int(os.getenv("EMBEDDING_RPM_LIMIT", "5000"))
    embedding_tpm_limit: int = int(os.getenv("EMBEDDING_TPM_LIMIT", "5000000"))
    ...
    drive_sync_max_parallel_downloads: int = int(os.getenv("DRIVE_SYNC_MAX_PARALLEL_DOWNLOADS", "5"))
    drive_sync_retry_attempts: int = int(os.getenv("DRIVE_SYNC_RETRY_ATTEMPTS", "3"))
    drive_sync_retry_base_delay: int = int(os.getenv("DRIVE_SYNC_RETRY_BASE_DELAY", "2"))
    drive_api_rate_limit_per_minute: int = int(os.getenv("DRIVE_API_RATE_LIMIT_PER_MINUTE", "30"))
    oauth_state_ttl_seconds: int = int(os.getenv("OAUTH_STATE_TTL_SECONDS", "600"))
    drive_download_chunk_size: int = int(os.getenv("DRIVE_DOWNLOAD_CHUNK_SIZE", "1048576"))
